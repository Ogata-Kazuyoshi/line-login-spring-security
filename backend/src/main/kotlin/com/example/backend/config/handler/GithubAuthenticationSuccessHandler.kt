...
open class GithubAuthenticationSuccessHandler(
    ...
    override fun onAuthenticationSuccess(
        ...
        val oid = principal.getAttribute<String>("node_id") ?: throw Exception("There is no userId")
        val displayName = principal.getAttribute<String>("login") ?: throw Exception("There is no name")
